...
export default class TtbtDetail extends React.Component {
    ...
    _renderUrls() {
        let urls = []
        console.log(this.state.movie.movies.files.length)
    ...
    _getUrl(url) {
        ...
        return (
            <li style={Styles.UrlLi}>
                <a href={url.download} style={{textDecoration: 'none'}}>{url.name}</a>
            </li>
        )
    }
}
